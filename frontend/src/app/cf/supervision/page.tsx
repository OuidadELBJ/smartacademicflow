    ...
    <DashboardLayout>
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          ...
          <p className="text-slate-500 text-xs">
            Filiere Genie Logiciel (GL) - Vue d'ensemble
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-4 gap-4 mb-6">
        <div className="card text-center">
          <BookOpen size={18} className="text-blue-600 mx-auto mb-2" strokeWidth={1.5} />
        ...
        <div className="card text-center">
          <TrendingUp size={18} className="text-violet-600 mx-auto mb-2" strokeWidth={1.5} />
          ...
          <div key={m.id} className={cn("card-hover", m.statut === "CLOTURE" && "opacity-70")}>
            <div className="flex items-center gap-4">
              <div className={cn(
                ...
                m.statut === "CLOTURE" ? "bg-slate-100" : "bg-blue-50"
              )}>
                {m.statut === "CLOTURE" ? (
              ...
              <div className="w-32">
                <div className="w-full h-2 bg-slate-100 rounded-full overflow-hidden">
                  <div
                    className={cn(
                      "h-full rounded-full",
                      m.progression === 100 ? "bg-emerald-500" :
                      m.progression < 50 ? "bg-amber-400" : "bg-blue-500"
                    )}
              ...
              {m.statut === "CLOTURE" ? (
                ...
                <span className="badge-info">
                  <Clock size={10} className="mr-1" strokeWidth={2} />
                  En cours
                </span>
              )}
            </div>
